                ...
                < View style={styles.PostsBlocks} >
                    ...
                    <View style={{ width: "100%", flexDirection: "row", margin: 20, marginLeft: 10 }}>
                        ...
                        <View style={{ flexDirection: "row", }}>
                            {
                                (() => {
                                    if (item.Counts.likeCount != undefined && item.Counts.likeCount > 0) {
                            ...
                            <Text style={{ fontSize: 22, color: "black", fontWeight: "bold", marginRight: 15 }}>{item.Counts.likeCount} </Text>
                        </View>
                            ...
                            <View className="ProfileTopContent" style={styles.ProfileTopContent}>
                                <View style={{ flexDirection: "row", }}>
                                    ...
                                    <View style={{ width: "70%", alignItems: 'center', }}>
                                        ...
                                        <Text style={{ fontWeight: "bold", color: "black", fontSize: 30, fontStyle: 'normal', margin: 10 }}>Hanuman</Text>
