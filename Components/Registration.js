        ...
        return (
            <View>
                ...
                <View style={styles.container}>
                    ...
                    <View>
                        <Text style={styles.LableHeadings}>User Name</Text>
                        <TextInput style={styles.input}
                            underlineColorAndroid="transparent"
                    ...
                    <View>
                        ...
                        <RadioButton.Group onValueChange={this.handleGender} value={this.state.gender}>
                            <View style={{ flexDirection: 'row' }}>
                                <View style={{ flexDirection: 'row' }}><RadioButton value="User" color="#4d089e" /><TouchableOpacity
                                >
                                    <Text style={styles.RadioText}>Male</Text>
                                </TouchableOpacity></View>
                                <View style={{ flexDirection: 'row' }}><RadioButton value="Business" color="#4d089e" /><TouchableOpacity>
